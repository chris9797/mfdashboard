...
fm.fontManager.addfont("Mulish-ExtraBold.ttf")
...
texts = [ax.text(x[i]+0.5, y[i]+0.5, f' {label}', fontsize=10, ha='right', va='bottom', fontweight='heavy') for i, label in enumerate(labels)]
